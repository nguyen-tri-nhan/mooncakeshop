...
public class AdminSearchController extends HttpServlet {
    ...
    private static final String END = "adminPage.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Double minPrice = Double.parseDouble(request.getParameter("txtMinPrice"));
            Double maxPrice = Double.parseDouble(request.getParameter("txtMaxPrice"));
            ...
            List<CakeDTO> list = dao.searchCakeAdmin(name, minPrice, maxPrice, categoryID, page);
