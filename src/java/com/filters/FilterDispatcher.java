    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.endsWith(".jpg") || resource.endsWith(".jpeg")
                    || resource.endsWith(".png") || resource.endsWith(".css") || resource.endsWith(".js")) {
                url = resource;
            } else {
                ResourceBundle siteMap = ResourceBundle.getBundle("com.utils.dispatcher");
                url = siteMap.getString(resource);
            }
        } catch (Exception e) {
        } finally {
            if (url != null) {
                ...
                ((HttpServletResponse) response).sendRedirect("empty");
            }
        }
    }
